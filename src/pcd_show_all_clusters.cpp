...
//***************************read PCD file*****************************************
    ...
    //输入点云路径
    string addr = "/home/lyl/Point_Cloud_Sengmentation/devel/lib/depth_clustering/clusters_000110/";
    string filename;
    //待处理点云个数
    int num = 97;
    
    boost::shared_ptr< pcl::visualization::PCLVisualizer > viewer(new pcl::visualization::PCLVisualizer("Viewer_all_clusters"));
    //背景颜色
